...
{% swagger src="https://swagger-api.truvera.io/openapi.yaml" path="/revocationStatus/{regId}/{revId}" method="get" %}
...
{% swagger src="https://swagger-api.truvera.io/openapi.yaml" path="/revocationStatus/{regId}/{revId}/witness" method="get" %}
[https://swagger-api.truvera.io/openapi.yaml](https://swagger-api.truvera.io/openapi.yaml)
{% endswagger %}
